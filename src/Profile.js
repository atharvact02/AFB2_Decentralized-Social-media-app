...
const App = ({ contract }) => {
    ...
    const uploadToIPFS = async (event) => {
        ...
        if (typeof file !== 'undefined') {
            try {
                ...
                setAvatar(`https://dwitter.infura-ipfs.io/ipfs/${result.path}`)
                console.log(`https://dwitter.infura-ipfs.io/ipfs/${result.path}`);
            } catch (error) {
    ...
    const mintProfile = async (event) => {
        ...
        try {
            ...
            setLoading(true)
            console.log(`https://dwitter.infura-ipfs.io/ipfs/${result.path}`);
            await (await contract.mint(`https://dwitter.infura-ipfs.io/ipfs/${result.path}`)).wait()
            //await 
            loadMyNFTs()
        } catch (error) {
